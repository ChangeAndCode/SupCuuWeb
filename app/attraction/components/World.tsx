    ...
    <div className='relative flex items-center pb-[5rem] px-[2rem] md:px-[5rem] lg:px-[9rem] xl:px-[11rem] 2xl:px-[19rem]'>
        <div>
            <h3 className='font-pragmatica main-Tipography text-[1.5rem] md:text-[2rem] lg:text-[2.5rem] xl:text-[4rem] 2xl:text-[5rem] 
                ...
                <span className='font-PerformanceMark text-[3rem] md:text-[4rem] lg:text-[5rem] xl:text-[7.5rem] 2xl:text-[9.5rem]'>
                    great ideas
                </span><br/>
                and the courage to<br/> pursue them <span className='font-poppins text-[1.5rem]'>-Paul Graham</span>
            </h3>
        </div>
        <div className='hidden md:block absolute right-0 md:right-9 lg:right-7 xl:right-[2rem] 2xl:right-[6rem] md:bottom-[-5rem] lg:bottom-[-2rem]
            xl:bottom-[-8.5rem] 2xl:bottom-[-8rem] w-[500px] h-[600px] md:w-[400px] md:h-[500px] lg:w-[500px] lg:h-[500px] 
