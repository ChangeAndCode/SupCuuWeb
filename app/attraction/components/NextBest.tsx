  ...
  return (
    <div className="flex flex-col items-center py-[4rem] px-[2rem] md:px-[4rem]">
      ...
      <div className="font-poppins text-ColorPrincipal text-[1rem] sm:text-[1.2rem] md:text-[2rem] xl:text-[2.5rem] 2xl:text-[3rem] uppercase xl:w-10/12 2xl:w-9/12 mt-[3rem] text-justify">
        <p>Is your enterprise looking for a stable and supportive ecosystem for optimum growth? Chihuahua is open and ready to assist small- and medium-sized companies desiring to connect and grow with the City&rsquo;s current industries and initiatives:</p>
      </div>
