...
const WhoIs = () => {
  return (
    <div className="flex flex-col items-center justify-center pt-[6rem] md:pt-[9rem] xl:pt-[11rem] pb-[9rem] sm:pb-[11rem] md:pb-[17rem]  px-[2rem] sm:px-[4rem] md:px-[4rem] lg:px-[6rem] 2xl:px-0">
