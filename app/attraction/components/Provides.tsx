  ...
  return (
    <>
      <h2 className="font-PerformanceMark text-ColorPrincipal text-center text-[1.7rem] md:text-[3rem] lg:text-[3.7rem] xl:text-[5rem] 2xl:text-[6rem]">
        What Startup Chihuahua Provides
      </h2>
      <h3 className="font-pragmatica main-Tipography text-ColorPrincipal text-center text-[.9rem] md:text-[1.5rem] lg:text-[1.9rem] xl:text-[2.5rem] 2xl:text-[3rem]">
        The Entrepreneurial Ecosystem of Chihuahua City
      </h3>
        ...
        <div className="w-11/12 md:w-8/12 xl:w-4/12">
          <div className="flex items-center mb-6">
            <Image
              ...
              loading="lazy"
            />
            <p className="font-poppins font-semibold text-[1.3rem] pt-12 md:pt-5">
              Assistance in accessing capital investments
            </p>
          </div>
          <div className="flex items-center mb-6">
            <Image
              ...
              loading="lazy"
            />
            <p className="font-poppins font-semibold text-[1.3rem] pt-20 sm:pt-12 md:pt-12">
              Networking opportunities with industry leaders and representatives
            </p>
          </div>
          <div className="flex items-center mb-6">
            <Image
              ...
              loading="lazy"
            />
            <p className="font-poppins font-semibold text-[1.3rem] pt-12 md:pt-12 2xl:pt-5">
              Access to applications for equity-free grant money
            </p>
          </div>
          <div className="flex items-center mb-6">
            <Image
            ...
            />
            <p className="font-poppins font-semibold text-[1.3rem] pt-20 sm:pt-12 md:pt-12">
              Entry to mentorship and professional development programs
            </p>
          </div>
          <div className="flex items-center mb-6">
            <Image
              ...
              loading="lazy"
            />
            <p className="font-poppins font-semibold text-[1.3rem] pt-20 sm:pt-12 md:pt-12 lg:pt-5 xl:pt-12">
              Opportunities for corporate sponsorship and collaboration
            </p>
          </div>
          <div className="flex items-center mb-6">
            <Image
              ...
              loading="lazy"
            />
            <p className="font-poppins font-semibold text-[1.3rem] pt-24 sm:pt-20 md:pt-12 xl:pt-20 2xl:pt-12">
              Connections to local entrepreneurial support (legal,
