    ...
    <div className="relative">
      ...
      >
        {data.showcasesContent.items.map((item, index) => {
          ...
          const infoUrl =
            hrefButtonOne && hrefButtonOne.length > 0
              ? hrefButtonOne[0].url
              : "#";
          const applyUrl =
            hrefButtonTwo && hrefButtonTwo.length > 0
              ? hrefButtonTwo[0].url
              : "#";

          // Get target attributes if they exist
          const infoTarget =
            hrefButtonOne && hrefButtonOne.length > 0 && hrefButtonOne[0].target
              ? hrefButtonOne[0].target
              : undefined;
          const applyTarget =
            hrefButtonTwo && hrefButtonTwo.length > 0 && hrefButtonTwo[0].target
              ? hrefButtonTwo[0].target
              : undefined;
            ...
            >
              ...
              >
                ...
                flex
                    ...
                    justify-center
                    items-center
                    w-[79%] /* Consider if this should be dynamic or removed */
                    h-40
                    bg-white"
                >
                ...
                >
                  ...
                  >
                    <p className="uppercase text-2xl leading-tight">{buttonOne}</p>
                  </Link>
                  ...
                  <Link
                    ...
                    max-sm:w-36 sm:w-36 md:w-[48%] lg:w-[48%] xl:w-36
                      ...
                      text-white font-bold
                      flex items-center justify-center
                      text-center /* Added for text wrapping */
                    `}
                    style={{ backgroundColor: `#${colorButtonTwo}` }}
                  >
                    <p className="uppercase text-2xl leading-tight">{buttonTwo}</p>
                  </Link>
                </div>
              </div>
              <div
