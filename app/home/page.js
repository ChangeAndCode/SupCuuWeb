  ...
  return (
    <div className="px-14 lg:px-24 xl:px-32 py-32 md:py-48">
      <div className="max-w-[1920px] mx-auto w-full">
        ...
        <p className="main-Tipography xs:text-[1.3rem] sm:text-[1.5rem] md:text-[3rem] lg:text-[3.8rem] xl:text-[5rem] 2xl:text-[7rem] md:leading-[3.5rem] lg:leading-[5rem] xl:leading-[5rem] 2xl:leading-[7rem] text-white uppercase">
          technology-based&nbsp;
