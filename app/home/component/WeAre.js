...
const WeAre = () => {
  return (
    <div className="overflow-hidden">
        ...
        <div className="flex items-center h-screen bg-[url('/Bg/bgWeAre.png')] bg-no-repeat bg-center bg-[length:120vw_100%] z-10 relative mac:px-[10rem] lg:px-[15rem] px-[2rem]">
