  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="flex items-center bg-[url('/Bg/bgWeAre.webp')] bg-no-repeat bg-center bg-cover z-10 relative px-[2rem] lg:px-[6rem] xl:px-[4rem] 2xl:px-[8rem] 4xl:px-[15rem] py-[12rem] md:py-[14rem] lg:py-[16rem] xl:py-[15rem] 4xl:py-[22rem]">
        <p className="uppercase font-poppins font-semibold text-white text-2xl md:text-[2.3rem] lg:text-[3rem] xl:text-[2rem] 2xl:text-[2.8rem] 4xl:text-[4rem] w-full xl:w-7/12 2xl:w-8/12 leading-[1.7rem] md:leading-[2.7rem] lg:leading-[3.2rem] 2xl:leading-[3.2rem] 4xl:leading-[4.5rem]">
