...
const Partners = () => {
  return (
    <div className="relative pb-14">
      <div className="flex justify-end">
        <div className="relative w-[1300px] h-[900px]">
          <Image
            ...
            quality={80}
          />
          <div className="absolute inset-[3.5rem] md:inset-[7.4rem] lg:inset-[9rem] xl:inset-[11.5rem] 2xl:inset-[12rem]">
      ...
      <div className="absolute inset-0 flex justify-center items-center mt-[-8rem] sm:mt-[-12rem] md:mt-[2rem] lg:mt-[4rem] xl:mt-[10rem] 2xl:mt-[10rem] z-10">
        <Image
          src="/tabla.webp"
          width={1400}
          height={1400}
