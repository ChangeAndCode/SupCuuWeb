// src/app/component/Backbone.tsx
"use client";
...
const Backbone = ({ teamBackbone }: BackboneProps) => {
  ...
  return (
    <div className="relative flex flex-col items-center lg:pb-[10rem] xl:pb-0 pt-[10rem] w-full">
            ...
            {teamBackbone.map((member, index) => (
              ...
              >
                <Image
                  ...
                  alt={`Team Backbone - ${member.memberName}`}
                  width={300}
                  height={300}
                  quality={80}
      ...
      <div className="relative z-30 mt-[28rem] sm:mt-[34rem] md:mt-[40rem] lg:mt-[46rem] xl:mt-[46rem] 4xl:mt-[58rem]">
        {selectedImage !== null && (
          <Bubble selectedImage={selectedImage} teamBackbone={teamBackbone} />
        )}
      </div>
    </div>
  );
